...
urlpatterns = [
    path('sales/', SaleViews.as_view(), name='restaurants'),  # all category restaurants
    ...
    path('restaurants/<int:pk>/', RestaurantDetailViews.as_view()),  # all restaurants with params 'category_id'
